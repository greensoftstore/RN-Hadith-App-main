...
const reducer = (state, action) => {
    ...
    switch (type) {
        ...
        case 'updateSearchListLocal': return { ...state, searchListLocal: payload, };
...
function ScreenDataComponent({ navigation, screenSettings, searchAutoFocus }) {
    ...
    const getSearch = useCallback(async (arr, bookArr, searchText) => {
        ...
        if (!res.error) {
            reduce({ type: 'updateSearchListLocal', payload: res.items });
